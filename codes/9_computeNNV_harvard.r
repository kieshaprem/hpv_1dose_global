...
for(COUNTRY in c('Uganda','ElSalvador','Nicaragua','US')) load(paste0('output/prime/impact_harvard',COUNTRY,'_indirect_batch.rdata'))
...
for(COUNTRY in c('Uganda','ElSalvador','Nicaragua','US'))
{
